...
execute if score @s[scores={OpLevel=..0}] gamemode matches 3 run function command:gamemode/error
...
execute if score @s[scores={OpLevel=1..}] gamemode matches 3 run function command:gamemode/mode/spectator
